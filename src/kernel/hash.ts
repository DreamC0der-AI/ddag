/**
 * SHA-256 (FIPS 180-4) over the UTF-8 bytes of a string, hex-encoded.
 * Pure and dependency-free so the kernel stays deterministic everywhere
 * (browser and Node) with no async WebCrypto plumbing.
 */
